...
*	The interrupt stops the read function of the IO-layer by calling IO::stop_Read() to let the UI call LL::exec().
*	The waiting FLAG is also cleared.
*	Directly calling the LL::exec() function messes with the VGA output.
*
 *  @param void
 *  @return void
*/
